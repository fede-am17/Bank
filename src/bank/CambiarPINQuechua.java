...
public class CambiarPINQuechua extends javax.swing.JFrame {
    ...
    private String userDir;
     ...
     public CambiarPINQuechua(String nombreCompleto, String numeroCuenta, String tipoMonedaSeleccionado, double balance) {
    initComponents();
    ...
    private CambiarPINQuechua(String juan_Perez) {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Contraseña nisqa takyachiy");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(confirmarPIN, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                    .addComponent(nuevoPIN))
                .addGap(87, 87, 87))
    ...
    if (nombreCompleto.isEmpty() || nuevoPinTxt.isEmpty() || confirmarPinTxt.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(this, "Yaykuna rimaykuna mana tupanchu");
    } else {
        ...
        try {
            ...
            if (!pinFile.exists()) {
                JOptionPane.showMessageDialog(this, "PIN willañiqiqa manam kay ruraqpaq kanchu");
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "Contraseña allinta tikrasqa");
            // Limpiar los campos después del cambio
            limpiarCampos();
            volverAlInicio();
        } catch (IOException e) {
            JOptionPane.showMessageDialog(this, "Yaykuna rimayta tikraspa pantasqa: " + e.getMessage());
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CambiarPINQuechua("Juan Perez").setVisible(true);
            }
        });
    }
