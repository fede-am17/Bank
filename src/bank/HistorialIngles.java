...
public class HistorialIngles extends javax.swing.JFrame {
    ...
    public HistorialIngles(String nombreCompleto, String numeroCuenta, String tipoMonedaSeleccionado, double balance) {
        ...
        modelMovimientos.addColumn("Type");
        modelMovimientos.addColumn("Amount");
