...
public class Historial extends javax.swing.JFrame {
    ...
    public Historial(String nombreCompleto, String numeroCuenta, String tipoMonedaSeleccionado, double balance) {
    ...
    /**
     * Este metodo carga el historial de transacciones de una cuenta desde un archivo
     * No tiene parametros
     * No tiene retornos
     * @exception IOException
     * Este método carga las transacciones registradas en el archivo 
     * historial.txt de la cuenta del usuario y actualiza la interfaz 
     * de usuario con estas transacciones
     */
